...
configpipath="/boot/config-user.txt"
...
log_action_msg "Remove dtoverlay configure from "${configpipath}" file"
sudo sed -i '/dtoverlay=dwc2,dr_mode=host/d' "${configpipath}"
